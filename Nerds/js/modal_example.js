...
try {
  storage = localStorage.getItem('username');
   //сюда пишется код, который может закончится ошибкой
} catch (err) {   //вместо err может быть другое слово, сюда попадет объект с информацией об ошибке
  isStorageSupport = false;   //если код сработает с ошибкой, то мы можем перехватить его здесь
}
